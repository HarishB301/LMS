    ...
    <section className={testimonialStyles.section}>
        <div className={testimonialStyles.container}>
            <div className={testimonialStyles.badge}>
                <div className={testimonialStyles.badgeDot}>
                ...
                <p className={testimonialStyles.subtitle}>
                    Discover how our learners transformed their career with hands on Projects and expert mentorship
                </p>
            </div>
        ...
        <div className={testimonialStyles.grid}>
            {
                ...
                testimonials.map((t,i)=>(
                     ...
                     onMouseLeave ={()=>onMouseLeave(cardRef.current[i])}>
                        ...
                        <article ref={(e1)=>(cardRef.current[i]=e1)}
                            className={testimonialStyles.cardShadow}
                            style={{
                                ...
                                <div className={testimonialStyles.quoteIcon}>
                                     <MessageSquareQuote className={testimonialStyles.quoteIconSvg}></MessageSquareQuote>
                                </div>
                                ...
                                <div className={testimonialStyles.footer}>
                                    <div className={testimonialStyles.verified}>
                                        <BadgeCheck className={testimonialStyles.verifiedIcon}></BadgeCheck>
                                        <span>Verified Student</span>
                                    </div>

                                    <div className={testimonialStyles.data}>
                                           <CalendarDays className={testimonialStyles.dateIcon}></CalendarDays>
                                           <span>2026</span>
                                    </div>
                                </div>
                        </article>
