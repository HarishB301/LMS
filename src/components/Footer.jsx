...
import{
    footerStyles,footerBackgroundStyles,
    footerCustomStyles,iconColors,contactIconGradients
} from '../assets/dummyStyles'
import {
    socialIcons,quickLinks,supportLinks,contactInfo
...
const Footer = () => {
  return (
    <footer className={footerCustomStyles.footer}>
        <div className={footerCustomStyles.footerBackgroundStyles}> 
                ...
                <div className={footerStyles.brandSection}>
                     <div className={footerStyles.brandTransform}>
                        ...
                        <p className={footerStyles.brandDescription}>
                            Transform your learning journey with interaction courses and cutting-edge
                            educational technology designed for modern learners
                        </p>
                   </div>
                </div>
                <div >
                    <h4 className={`${footerStyles.sectionHeader} ${iconColors.cyan}`}>
                    <ArrowRight className={footerStyles.sectionHeader}/>
                    QuickLinks
                    </h4>
                        ...
                        {quickLinks.map((link,index)=>{
                            ...
                            return(
                                <li key={link.name}> 
                                    ...
                                    > <Icon className={`${footerStyles.linkIcon} ${iconColors.cyan}`}></Icon>
                                    <span className='truncate'>{link.name}</span></a>
                                </li>
                            )
                        })}
                    </ul>
                 ...
                 <div >
                    ...
                    <ul className={footerStyles.supportLinks}>
                        {supportLinks.map((link,index)=>{
                            ...
                            return(
                                <li key={link.name}> 
                                    ...
                                    > <Icon className={`${footerStyles.linkIcon} ${iconColors.purple}`}></Icon>
                                    <span className='truncate'>{link.name}</span></a>
                                </li>
                            )
                        })}
                    ...
                    <div className={footerStyles.contactSpace}>
                       <div className={footerStyles.contactItem}>
                         <div className={`${footerStyles.contactIconContainer} ${contactIconGradients.address}`}>
                            <MapPin className={`${footerStyles.contactIcon} ${iconColors.cyan600}`}></MapPin>
                        </div>
                     ...
                     <div className={footerStyles.contactSpace}>
                       <div className={footerStyles.contactItem}>
                         <div className={`${footerStyles.contactIconContainer} ${contactIconGradients.address}`}>
                            <Phone className={`${footerStyles.contactIcon} ${iconColors.purple}`}></Phone>
                        </div>
                        <div className={footerStyles.contactTextContainer}>
                            <p className={footerStyles.contactTextPrimary}>
                               {contactInfo.phone}
                     ...
                     <div className={footerStyles.contactSpace}>
                       <div className={footerStyles.contactItem}>
                         <div className={`${footerStyles.contactIconContainer} ${contactIconGradients.address}`}>
                            <Mail className={`${footerStyles.contactIcon} ${iconColors.purple600}`}></Mail>
                        </div>
                        <div className={footerStyles.contactTextContainer}>
                            <p className={footerStyles.contactTextPrimary}>
                               {contactInfo.email}
