...
import {counterTargets,statsMeta,missionVisionValues,
  teamMembers,values,testimonials} from '../assets/dummyAbout'
    ...
    <div className={aboutUsStyles.container}>
      <section className={aboutUsStyles.heroSection}>
         <div className={aboutUsStyles.heroBackground}>
             <div style={{background:`url(${AboutBanner})`,
             opacity:0.85}}
         ...
         <div className={aboutUsStyles.heroContent}>
            <div className={aboutUsStyles.trustBadge}>
                <Star className={aboutUsStyles.trustIcon}></Star>
                trusted by 50,000+ students world wide
            </div>
         ...
         ${section.bgColor} ${index%2===1 ? "bg-white":""}`}>
          <div className={aboutUsStyles.sectionGrid}>
            ...
            ${index % 2 === 1 ? "ig:grid-flow-dense":""}`}>
               ...
               ${index % 2 ===1 ? 'lg:col-start-1 lg:rowstart':''}`}>
                <div className={aboutUsStyles.sectionBadge}>
                      <section.icon className={`${aboutUsStyles.sectionIcon}
                       ${section.color}`}/>
             ...
             <div className={aboutUsStyles.teamGrid}>
              {teamMembers.map((member,index)=>(
                <div key={index} className={aboutUsStyles.teamMember}> 
                   ...
                   <h3 className={aboutUsStyles.teamRole}>{member.role}</h3>
                   <h3 className={aboutUsStyles.teamBio}>{member.bio}</h3>
          ...
          <div className={aboutUsStyles.ctaOrb2}/>
              <div className={aboutUsStyles.ctaContent}>
                ...
                <p className={aboutUsStyles.ctaDescription}>
                  Join millions of learners who have transformed their lives with LearnHub.
                  Start your journey today with a 7-day free trail.
                </p>
