...
const HomeCourse = () => {
    ...
    const{title,couse:courseFont, detail} = homeCoursesStyles.fonts;
        ...
        <div className={homeCoursesStyles.mainContainer}>
            <div className={homeCoursesStyles.header}>
                <h2 className={`${title} ${homeCoursesStyles.title}`}>
                    <Star className={homeCoursesStyles.titleIcon}></Star>
                    Explore Top Courses
                    <Star className={homeCoursesStyles.titleIcon}></Star>
                </h2>
            </div>
                            ...
                            className={homeCoursesStyles.coursesCard}>
                             ...
                             <div className={homeCoursesStyles.courseInfo}>
                                ...
                                <div className={`${detail}${homeCoursesStyles.teacherInfo}`}>
                                    <User size={15} className={homeCoursesStyles.teacherIcon}></User>
                ...
                <div className={homeCoursesStyles.ctaContainer}>
                     <div className={homeCoursesStyles.ctaWrapper}>
                        <span className={homeCoursesStyles.ctaGlow}
                               style={{
                                zIndex: 0,
                                background:"conic-gradient(from 0deg, rgba(236,72,153,0.9), rgba(99,102,241,0.9), rgba(139,92,246,0.9), rgba(236,72,153,0.9))",
                                filter: "blur(5px)",
                                 opacity: 0.8,
                        }}/>
                            
                        <button onClick={handleBrowseClick} className={homeCoursesStyles.ctaButton}
                            style={{
