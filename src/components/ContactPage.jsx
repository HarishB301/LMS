...
import {Mailbox, User,MessageSquare,Phone, MessageCircleDashed,MessageCircle, SendHorizonal} from 'lucide-react'
const ContactPage = () => {
  ...
  const handleChange=(e)=>{
   ...
   const handleSubmit =(e)=>{
    ...
    const whatsappUrl = `https://wa.me/7993405925?text=${whatsappMessage}`;
      ...
      <div className={contactStyles.mainContainer}>
                    ...
                    <div className={contactStyles.formGroup}>
                        ...
                        <div className={contactStyles.formGroup}>
                            <label className={contactStyles.label}>
                                ...
                                ${contactStyles.colors.blue.icon}`}></MessageCircleDashed>
                                Message
                            </label>
                            <textarea name='message' value={formData.message} onChange={handleChange}
                            required rows='5' className={`${contactStyles.textarea}
                             ${contactStyles.colors.blue.focus}`} placeholder='Tell Us about your Project or Enquiry'
                             ></textarea>
                        </div>
                        <button type='submit' 
                        disabled={!isFormValid ||  isSubmitting} className={`${contactStyles.submitButton}
                        ${isFormValid && !isSubmitting ? contactStyles.submitButtonEnabled:
                         contactStyles.submitButtonDisabled}`}>
                            {
                                isSubmitting ? (
                                    ...
                                    <>
                                     <SendHorizonal className={contactStyles.submitIcon}></SendHorizonal>
                                     Send Message
                                    </>
                                )
                            }
        ...
        <div className={contactStyles.footer}>
            <div className={contactStyles.footerBadge}>
                <MessageCircle className={contactStyles.footerIcon}></MessageCircle>
